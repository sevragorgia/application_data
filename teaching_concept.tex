...
\else
	\backgroundsetup{
		...
		opacity=0.60,
		scale=2.5,
		contents={\tikz\node[text=black,fill=gray!40,align=left, minimum width=4.0cm,minimum height=0.6cm,inner sep=0]{D\"usseldorf, Zoology};}}
\fi%
}
...
\chead{}
\rhead{{\footnotesize D\"usseldorf Zoology, Teaching Concept}}
\lfoot{\ccbynd}
\cfoot{\thepage}
\rfoot{}
